...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["api.savollar.leetcode.uz"])
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="Respondent Web <noreply@api.savollar.leetcode.uz>",
)
