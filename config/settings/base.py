...
ADMINS = [("""Gayratbek Sultonov""", "gayratbek.sultonov@gmail.com")]
...
# django-allauth
# ------------------------------------------------------------------------------
# Note: Allauth is disabled for this phone-based authentication system
# We use custom API endpoints for authentication instead
...
SPECTACULAR_SETTINGS = {
    ...
    'TAGS': [
        ...
        {'name': 'Интеграции', 'description': 'Интеграция с внешними системами (1C)'},
    ],
}
# JWT Configuration
# ------------------------------------------------------------------------------
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': env('JWT_SECRET_KEY', default='your-secret-key-change-in-production'),
    'VERIFYING_KEY': None,
    'AUDIENCE': None,
    'ISSUER': None,
    'JWK_URL': None,
